...
export default function Navbar() {
  ...
  return (
    <>
      <div style={{ height: '64px', background: 'var(--surface)', borderBottom: '1px solid var(--green-border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <img src="/logo-kinesis.png" alt="Kinesis" style={{ width: '28px', height: '28px' }} />
          <h1 style={{ fontSize: '1rem', fontWeight: 700, color: 'var(--muted)', letterSpacing: '0.05em' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              <div style={{ width: '36px', height: '36px', borderRadius: '50%', background: 'var(--green)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            {showDropdown && (
              <div style={{ position: 'absolute', right: 0, top: 'calc(100% + 8px)', width: '220px', background: 'var(--surface)', border: '1px solid var(--green-border)', borderRadius: '12px', overflow: 'hidden', zIndex: 50 }}>
                <div style={{ padding: '16px', borderBottom: '1px solid var(--green-border)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                    <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'var(--green)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <span style={{ color: '#000', fontWeight: 900 }}>{user?.username?.charAt(0).toUpperCase()}</span>
                    </div>
                    <div>
                      <p style={{ color: 'var(--text)', fontWeight: 700, fontSize: '0.85rem' }}>{user?.username}</p>
                      {role === "admin" && (
                ...
                <button
                  ...
                  style={{ width: '100%', padding: '12px 16px', textAlign: 'left', border: 'none', background: 'transparent', cursor: 'pointer', color: '#00ff88', fontSize: '0.8rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '8px' }}
                >
                  + Add Funds
                </button>
                <button
